...
/*
	...
	X Create a Javascript object containing an array of records with each record including an array
	X Convert the Javascript object into a JSON object
	X Store the JSON object into local storage
	
	This will be given to students to run as part of a web page that will consume the JSON object
	Goal: Provide an example of how to create a JSON object in JS	-done
...
localStorage.setItem("studentall", JSON.stringify(studentall));
